...
COMMENT ON FUNCTION public.lincoln_early_modern_agenda_zone IS 'Layer for all Arches resources with the protection type "Early Modern Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_roman_military_agenda_zone IS 'Layer for all Arches resources with the protection type "Roman Military Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_roman_colonia_agenda_zone IS 'Layer for all Arches resources with the protection type "Roman Colonia Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_industrial_agenda_zone IS 'Layer for all Arches resources with the protection type "Industrial Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_prehistoric_agenda_zone IS 'Layer for all Arches resources with the protection type "Prehistoric Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_high_medieval_agenda_zone IS 'Layer for all Arches resources with the protection type "High Medieval Research Agenda Zone".';
...
COMMENT ON FUNCTION public.lincoln_early_medieval_agenda_zone IS 'Layer for all Arches resources with the protection type "Early Medieval Research Agenda Zone".';
